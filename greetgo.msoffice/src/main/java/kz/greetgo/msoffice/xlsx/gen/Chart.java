...
public class Chart {
  ...
  void print(PrintStream os) {
    ...
    buf.append(title);
    buf.append("</a:t></a:r></a:p></c:rich></c:tx><c:layout/></c:title><c:view3D><c:rotX val=\"30\"/><c:perspective val=\"30\"/></c:view3D><c:plotArea><c:layout/><c:");
    buf.append(type.tag);
    buf.append(">");
    ...
    if (type == ChartType.LINE_CHART) {
      //      buf.append("<c:spPr><a:solidFill><a:srgbClr val=\"000000\"/></a:solidFill><a:ln w=\"18440\"><a:solidFill><a:srgbClr val=\"000000\"/></a:solidFill><a:round/></a:ln></c:spPr><c:dLbls><c:dLbl><c:idx val=\"0\"/><c:dLblPos val=\"outEnd\"/><c:showLegendKey val=\"0\"/><c:showVal val=\"0\"/><c:showCatName val=\"0\"/><c:showSerName val=\"0\"/><c:showPercent val=\"0\"/></c:dLbl><c:dLbl><c:idx val=\"1\"/><c:dLblPos val=\"outEnd\"/><c:showLegendKey val=\"0\"/><c:showVal val=\"0\"/><c:showCatName val=\"0\"/><c:showSerName val=\"0\"/><c:showPercent val=\"0\"/></c:dLbl><c:dLbl><c:idx val=\"2\"/><c:dLblPos val=\"outEnd\"/><c:showLegendKey val=\"0\"/><c:showVal val=\"0\"/><c:showCatName val=\"0\"/><c:showSerName val=\"0\"/><c:showPercent val=\"0\"/></c:dLbl><c:dLbl><c:idx val=\"3\"/><c:dLblPos val=\"outEnd\"/><c:showLegendKey val=\"0\"/><c:showVal val=\"0\"/><c:showCatName val=\"0\"/><c:showSerName val=\"0\"/><c:showPercent val=\"0\"/></c:dLbl><c:dLblPos val=\"outEnd\"/><c:showLegendKey val=\"0\"/><c:showVal val=\"0\"/><c:showCatName val=\"0\"/><c:showSerName val=\"0\"/><c:showPercent val=\"0\"/></c:dLbls>");
    }
    ...
    if (type == ChartType.LINE_CHART) {
      buf.append("<c:hiLowLines><c:spPr><a:ln><a:noFill/></a:ln></c:spPr></c:hiLowLines><c:upDownBars><c:gapWidth val=\"150\"/><c:upBars></c:upBars><c:downBars></c:downBars></c:upDownBars><c:marker val=\"0\"/><c:axId val=\"12344193\"/><c:axId val=\"63668120\"/>");
    }
    ...
    if (type == ChartType.LINE_CHART) {
      buf.append("<c:catAx><c:axId val=\"12344193\"/><c:scaling><c:orientation val=\"minMax\"/></c:scaling><c:delete val=\"0\"/><c:axPos val=\"b\"/><c:majorTickMark val=\"out\"/><c:minorTickMark val=\"none\"/><c:tickLblPos val=\"nextTo\"/><c:spPr><a:ln w=\"9360\"><a:solidFill><a:srgbClr val=\"878787\"/></a:solidFill><a:round/></a:ln></c:spPr><c:crossAx val=\"63668120\"/><c:crosses val=\"autoZero\"/><c:auto val=\"1\"/><c:lblAlgn val=\"ctr\"/><c:lblOffset val=\"100\"/></c:catAx>");
      buf.append("<c:valAx><c:axId val=\"63668120\"/><c:scaling><c:orientation val=\"minMax\"/></c:scaling><c:delete val=\"0\"/><c:axPos val=\"");
      buf.append(alignOY.getTag());
      buf.append("\"/><c:majorTickMark val=\"out\"/><c:minorTickMark val=\"none\"/><c:tickLblPos val=\"nextTo\"/><c:spPr><a:ln><a:solidFill><a:srgbClr val=\"b3b3b3\"/></a:solidFill></a:ln></c:spPr><c:crossAx val=\"12344193\"/><c:crosses val=\"max\"/></c:valAx>");
      buf.append("<c:spPr><a:solidFill><a:srgbClr val=\"eeeeee\"/></a:solidFill><a:ln><a:noFill/></a:ln></c:spPr>");
    }
